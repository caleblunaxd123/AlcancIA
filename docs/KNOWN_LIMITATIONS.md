...
1c. **Envío de correos por Gmail SMTP.** Contraseña de aplicación en user-secrets. Límite de Gmail (~500/día) y riesgo de spam: para producción usar un proveedor transaccional con dominio propio.
